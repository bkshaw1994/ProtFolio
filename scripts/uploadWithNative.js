...
const profileData = {
  ...
  socialLinks: {
    ...
    twitter: "",
    portfolio: "https://bishalshaw.dev",
    instagram: ""
  },
  yearsOfExperience: 9,
  isActive: true,
...
const experienceData = [
  {
    ...
    isCurrent: true,
    description: "Working on full-stack web application development using MERN stack with CI/CD and cloud deployment.",
    responsibilities: [
    ...
    technologies: ["React", "Node.js", "MongoDB", "Express", "AWS", "GitHub Actions"],
  ...
  },
  {
    ...
    isCurrent: false,
    description: "Lead Front-End Developer managing frontend delivery and team coordination.",
    responsibilities: [
  ...
  },
  {
    ...
    isCurrent: false,
    description: "Front-End Developer working for Laminaar Aviation Infotech (Client).",
    responsibilities: [
...
const skillsData = [
  { name: "React", category: "frontend", proficiency: 95, description: "Advanced React.js development", yearsOfExperience: 5, icon: "react", priority: 1, isCore: true, isActive: true },
  { name: "Node.js", category: "backend", proficiency: 90, description: "Server-side JavaScript", yearsOfExperience: 6, icon: "nodejs", priority: 1, isCore: true, isActive: true },
  { name: "MongoDB", category: "database", proficiency: 85, description: "NoSQL database design", yearsOfExperience: 4, icon: "mongodb", priority: 1, isCore: true, isActive: true },
  { name: "JavaScript", category: "frontend", proficiency: 95, description: "Modern JavaScript ES6+", yearsOfExperience: 7, icon: "javascript", priority: 1, isCore: true, isActive: true },
  { name: "TypeScript", category: "frontend", proficiency: 80, description: "Typed JavaScript", yearsOfExperience: 3, icon: "typescript", priority: 2, isCore: true, isActive: true },
  { name: "AWS", category: "devops", proficiency: 75, description: "Cloud infrastructure", yearsOfExperience: 3, icon: "aws", priority: 2, isCore: true, isActive: true },
  { name: "Docker", category: "tools", proficiency: 70, description: "Containerization", yearsOfExperience: 2, icon: "docker", priority: 2, isCore: false, isActive: true },
  { name: "Express.js", category: "backend", proficiency: 90, description: "Web framework for Node.js", yearsOfExperience: 5, icon: "express", priority: 1, isCore: true, isActive: true }
...
const projectsData = [
  {
    ...
    description: "A comprehensive e-commerce platform built with MERN stack featuring user authentication, product catalog, shopping cart, payment integration, and admin dashboard.",
  ...
  },
  {
    ...
    description: "A collaborative task management system similar to Trello, built with React and Node.js. Features include drag-and-drop functionality, real-time updates, and team collaboration.",
  ...
  },
  {
    ...
    description: "A comprehensive weather dashboard that provides current weather conditions, forecasts, and weather maps.",
...
].map(project => ({ ...project, createdAt: new Date(), updatedAt: new Date() }));

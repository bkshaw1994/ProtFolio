...
const skillsData = [
  {
    ...
    category: "frontend",
    proficiency: 95,
    description: "Advanced React.js development with hooks, context, and modern patterns",
    yearsOfExperience: 5,
    icon: "react",
    priority: 1,
    isCore: true,
  ...
  },
  {
    ...
    category: "backend",
    proficiency: 90,
    description: "Server-side JavaScript development with Express.js and RESTful APIs",
    yearsOfExperience: 6,
    icon: "nodejs",
    priority: 1,
    isCore: true,
...
const projectsData = [
  {
    ...
    description: "A comprehensive e-commerce platform built with MERN stack featuring user authentication, product catalog, shopping cart, payment integration, and admin dashboard. Implemented responsive design and optimized performance.",
  ...
  },
  {
    ...
    description: "A collaborative task management system similar to Trello, built with React and Node.js. Features include drag-and-drop functionality, real-time updates, team collaboration, and project analytics.",
  ...
  },
  {
    ...
    description: "A comprehensive weather dashboard that provides current weather conditions, forecasts, and weather maps. Features location-based weather, favorite locations, and weather alerts.",
